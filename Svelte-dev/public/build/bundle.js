...
var app = (function () {
    ...
    const file$9 = "src\\components\\MenuTopic.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			t = text(/*entry*/ ctx[0]);
    			add_location(div, file$9, 6, 2, 58);
    			attr_dev(main, "class", "svelte-53x9nk");
    			add_location(main, file$9, 5, 0, 48);
    		},
    ...
    const file$8 = "src\\components\\DataComponent.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 4, 2, 57);
    			attr_dev(main, "class", "svelte-u4pjps");
    			add_location(main, file$8, 3, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class DataComponent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { dataName: 0 });
    ...
    const file$7 = "src\\components\\DataPane.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 19, 6, 491);
    			add_location(script, file$7, 22, 6, 583);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 13, 6, 332);
    			add_location(script, file$7, 16, 6, 425);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(datacomponent, div, null);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 10, 0, 253);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\components\\ShowData.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$6, 18, 4, 450);
    			attr_dev(div, "class", "navMinor svelte-x10s6l");
    			add_location(div, file$6, 17, 2, 422);
    			add_location(main, file$6, 16, 0, 412);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$5, 7, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src\\components\\UsualApp.svelte";
    ...
    class MyFuncs extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { myURL: 0, myfetch: 1 });
    ...
    const file$3 = "src\\routes\\register.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 54, 2, 1385);
    			attr_dev(input0, "placeholder", "firstname");
    			add_location(input0, file$3, 55, 2, 1411);
    			attr_dev(input1, "placeholder", "lastname");
    			add_location(input1, file$3, 56, 2, 1469);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "placeholder", "foo@bar.falk");
    			add_location(input2, file$3, 57, 2, 1525);
    			attr_dev(input3, "type", "password");
    			attr_dev(input3, "placeholder", "your password as hash");
    			add_location(input3, file$3, 59, 2, 1687);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 60, 2, 1771);
    			attr_dev(form, "class", "get-info");
    			add_location(form, file$3, 53, 0, 1358);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 18, 2, 347);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Passwort");
    			add_location(input1, file$2, 19, 2, 410);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$2, 20, 2, 481);
    			attr_dev(main, "class", "get-info");
    			add_location(main, file$2, 16, 0, 318);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\Footer.svelte generated by Svelte v3.54.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			a0 = element("a");
    			a0.textContent = "Projektbeschreibung";
    			t2 = text("  |  \r\n        ");
    			a1 = element("a");
    			a1.textContent = "Team";
    			t4 = text("  |  \r\n        ");
    			a2 = element("a");
    			a2.textContent = "Dokumentation";
    			t6 = text("  | \r\n        ");
    			a3 = element("a");
    			a3.textContent = "Impressum";
    			t8 = space();
    			br1 = element("br");
    			add_location(br0, file$1, 16, 4, 460);
    			attr_dev(a0, "href", "http://www.google.de");
    			attr_dev(a0, "class", "svelte-h96fe4");
    			add_location(a0, file$1, 17, 8, 474);
    			attr_dev(a1, "href", "http://www.google.de");
    			attr_dev(a1, "class", "svelte-h96fe4");
    			add_location(a1, file$1, 18, 8, 543);
    			attr_dev(a2, "href", "http://www.google.de");
    			attr_dev(a2, "class", "svelte-h96fe4");
    			add_location(a2, file$1, 19, 8, 597);
    			attr_dev(a3, "href", "http://www.google.de");
    			attr_dev(a3, "class", "svelte-h96fe4");
    			add_location(a3, file$1, 20, 8, 659);
    			add_location(br1, file$1, 21, 4, 709);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "XD");
    			attr_dev(img, "class", "svelte-1atvyus");
    			add_location(img, file, 13, 6, 300);
    			add_location(div0, file, 12, 4, 287);
    			attr_dev(header, "class", "svelte-1atvyus");
    			add_location(header, file, 11, 2, 273);
    			attr_dev(div1, "class", "content svelte-1atvyus");
    			add_location(div1, file, 16, 2, 378);
    			attr_dev(footer1, "class", "svelte-1atvyus");
    			add_location(footer1, file, 20, 2, 454);
    			attr_dev(main, "class", "svelte-1atvyus");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ UsualApp, Register, Login, Footer, name });
