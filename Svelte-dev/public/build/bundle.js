...
var app = (function () {
    ...
    const file$6 = "src/components/MenuTopic.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(/*entry*/ ctx[0]);
    			attr_dev(p, "class", "navMain svelte-1phd03a");
    			add_location(p, file$6, 7, 4, 62);
    			add_location(div, file$6, 6, 2, 52);
    			add_location(main, file$6, 5, 0, 43);
    		},
    ...
    const file$3 = "src/components/ShowData.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 18, 4, 427);
    			attr_dev(div, "class", "navMinor svelte-1oj9gq7");
    			add_location(div, file$3, 17, 2, 400);
    			add_location(main, file$3, 16, 0, 391);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/components/Thumbnail.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 7, 0, 92);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/components/UsualApp.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$1, 9, 4, 247);
    			attr_dev(div0, "class", "baseMenuSide svelte-ir9zvh");
    			add_location(div0, file$1, 8, 2, 216);
    			add_location(p1, file$1, 16, 4, 429);
    			attr_dev(div1, "id", "dataToShow");
    			attr_dev(div1, "class", "dataPane svelte-ir9zvh");
    			add_location(div1, file$1, 15, 2, 386);
    			attr_dev(p2, "class", "thumbnail");
    			add_location(p2, file$1, 21, 4, 498);
    			attr_dev(div2, "class", "metaInfo svelte-ir9zvh");
    			add_location(div2, file$1, 20, 2, 471);
    			attr_dev(main, "class", "svelte-ir9zvh");
    			add_location(main, file$1, 7, 0, 207);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	let p;
    	let current;
    	usualapp = new UsualApp({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			div1 = element("div");
    			create_component(usualapp.$$.fragment);
    			t1 = space();
    			...
    			attr_dev(img, "alt", "XD");
    			attr_dev(img, "class", "svelte-jcqqa4");
    			add_location(img, file, 10, 6, 137);
    			add_location(div0, file, 9, 4, 125);
    			attr_dev(header, "class", "svelte-jcqqa4");
    			add_location(header, file, 8, 2, 112);
    			attr_dev(div1, "class", "content svelte-jcqqa4");
    			add_location(div1, file, 13, 2, 212);
    			add_location(p, file, 17, 4, 276);
    			attr_dev(footer, "class", "svelte-jcqqa4");
    			add_location(footer, file, 16, 2, 263);
    			attr_dev(main, "class", "svelte-jcqqa4");
    			add_location(main, file, 7, 0, 103);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t0);
    			append_dev(main, div1);
    			mount_component(usualapp, div1, null);
    			append_dev(main, t1);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(usualapp.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(usualapp.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(usualapp);
    		}
    	};
